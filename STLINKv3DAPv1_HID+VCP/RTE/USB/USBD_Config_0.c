...
#define USBD0_STR_DESC_MAN              L"RadioOperator"

//     <s.126>Product String
//     <i>String Descriptor describing Product.
#define USBD0_STR_DESC_PROD             L"HighSpeed-HID CMSIS-DAP"
