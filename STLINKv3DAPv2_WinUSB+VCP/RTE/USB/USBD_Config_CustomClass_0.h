...
//           <0=>OUT
//           <1=>IN
#define USBD_CUSTOM_CLASS0_IF0_EP2_BENDPOINTADDRESS                0x04
...
//           <3=>Interrupt
//           <1=>Isochronous
#define USBD_CUSTOM_CLASS0_IF0_EP3_BMATTRIBUTES                    0x02
...
//           <0=>OUT
//           <1=>IN
#define USBD_CUSTOM_CLASS0_IF0_EP3_BENDPOINTADDRESS                0x84
...
//               <i>For Interrupt Endpoint set value to 1 .. 255 (polling interval).
//               <i>For Isochronous Endpoint set value to 1 .. 16 (polling interval is 2^(value-1)).
#define USBD_CUSTOM_CLASS0_IF0_EP3_FS_BINTERVAL                    0
...
//                 <1=>1 additional
//                 <2=>2 additional
#define USBD_CUSTOM_CLASS0_IF0_EP3_HS_WMAXPACKETSIZE               512
...
//               <i>For Interrupt Endpoint set value to 1 .. 16 (polling interval is 2^(value-1)).
//               <i>For Isochronous Endpoint set value to 1 .. 16 (polling interval is 2^(value-1)).
#define USBD_CUSTOM_CLASS0_IF0_EP3_HS_BINTERVAL                    0
...
//           <3=>Interrupt
//           <1=>Isochronous
#define USBD_CUSTOM_CLASS0_IF0_EP4_BMATTRIBUTES                    0x03
...
//           <0=>OUT
//           <1=>IN
#define USBD_CUSTOM_CLASS0_IF0_EP4_BENDPOINTADDRESS                0x83
...
//               <i>For Interrupt Endpoint set value to 1 .. 64.
//               <i>For Isochronous Endpoint set value to 1 .. 1023.
#define USBD_CUSTOM_CLASS0_IF0_EP4_FS_WMAXPACKETSIZE               64
...
//                 <1=>1 additional
//                 <2=>2 additional
#define USBD_CUSTOM_CLASS0_IF0_EP4_HS_WMAXPACKETSIZE               512
...
//               <i>For Interrupt Endpoint set value to 1 .. 16 (polling interval is 2^(value-1)).
//               <i>For Isochronous Endpoint set value to 1 .. 16 (polling interval is 2^(value-1)).
#define USBD_CUSTOM_CLASS0_IF0_EP4_HS_BINTERVAL                    0
...
//           <3=>Interrupt
//           <1=>Isochronous
#define USBD_CUSTOM_CLASS0_IF0_EP5_BMATTRIBUTES                    0x03
...
//           <0=>OUT
//           <1=>IN
#define USBD_CUSTOM_CLASS0_IF0_EP5_BENDPOINTADDRESS                0x04
...
//               <i>For Interrupt Endpoint set value to 1 .. 64.
//               <i>For Isochronous Endpoint set value to 1 .. 1023.
#define USBD_CUSTOM_CLASS0_IF0_EP5_FS_WMAXPACKETSIZE               64
...
//           <0=>OUT
//           <1=>IN
#define USBD_CUSTOM_CLASS0_IF0_EP6_BENDPOINTADDRESS                0x84
...
//               <i>For Interrupt Endpoint set value to 1 .. 255 (polling interval).
//               <i>For Isochronous Endpoint set value to 1 .. 16 (polling interval is 2^(value-1)).
#define USBD_CUSTOM_CLASS0_IF0_EP6_FS_BINTERVAL                    1
...
//                 <1=>1 additional
//                 <2=>2 additional
#define USBD_CUSTOM_CLASS0_IF0_EP6_HS_WMAXPACKETSIZE               1024
...
//               <i>For Interrupt Endpoint set value to 1 .. 16 (polling interval is 2^(value-1)).
//               <i>For Isochronous Endpoint set value to 1 .. 16 (polling interval is 2^(value-1)).
#define USBD_CUSTOM_CLASS0_IF0_EP6_HS_BINTERVAL                    1
...
//         <0xFE=>0xFE: Application Specific
//         <0xFF=>0xFF: Vendor Specific
#define USBD_CUSTOM_CLASS0_IF1_CLASS                               0x0A
...
//           <3=>Interrupt
//           <1=>Isochronous
#define USBD_CUSTOM_CLASS0_IF1_EP0_BMATTRIBUTES                    0x03
...
//           <0=>OUT
//           <1=>IN
#define USBD_CUSTOM_CLASS0_IF1_EP0_BENDPOINTADDRESS                0x03
...
//               <i>For Interrupt Endpoint set value to 1 .. 64.
//               <i>For Isochronous Endpoint set value to 1 .. 1023.
#define USBD_CUSTOM_CLASS0_IF1_EP0_FS_WMAXPACKETSIZE               16
...
//               <i>For Interrupt Endpoint set value to 1 .. 255 (polling interval).
//               <i>For Isochronous Endpoint set value to 1 .. 16 (polling interval is 2^(value-1)).
#define USBD_CUSTOM_CLASS0_IF1_EP0_FS_BINTERVAL                    1
...
//                 <1=>1 additional
//                 <2=>2 additional
#define USBD_CUSTOM_CLASS0_IF1_EP0_HS_WMAXPACKETSIZE               16
...
//               <i>For Interrupt Endpoint set value to 1 .. 16 (polling interval is 2^(value-1)).
//               <i>For Isochronous Endpoint set value to 1 .. 16 (polling interval is 2^(value-1)).
#define USBD_CUSTOM_CLASS0_IF1_EP0_HS_BINTERVAL                    1
...
//           <3=>Interrupt
//           <1=>Isochronous
#define USBD_CUSTOM_CLASS0_IF1_EP1_BMATTRIBUTES                    0x03
...
//           <0=>OUT
//           <1=>IN
#define USBD_CUSTOM_CLASS0_IF1_EP1_BENDPOINTADDRESS                0x83
...
//               <i>For Interrupt Endpoint set value to 1 .. 64.
//               <i>For Isochronous Endpoint set value to 1 .. 1023.
#define USBD_CUSTOM_CLASS0_IF1_EP1_FS_WMAXPACKETSIZE               16
...
//               <i>For Interrupt Endpoint set value to 1 .. 255 (polling interval).
//               <i>For Isochronous Endpoint set value to 1 .. 16 (polling interval is 2^(value-1)).
#define USBD_CUSTOM_CLASS0_IF1_EP1_FS_BINTERVAL                    1
...
//                 <1=>1 additional
//                 <2=>2 additional
#define USBD_CUSTOM_CLASS0_IF1_EP1_HS_WMAXPACKETSIZE               16
...
//               <i>For Interrupt Endpoint set value to 1 .. 16 (polling interval is 2^(value-1)).
//               <i>For Isochronous Endpoint set value to 1 .. 16 (polling interval is 2^(value-1)).
#define USBD_CUSTOM_CLASS0_IF1_EP1_HS_BINTERVAL                    1
...
#define USBD_CUSTOM_CLASS0_IF1_STR_EN                              1

//         <s.126>Interface String
#define USBD_CUSTOM_CLASS0_IF1_STR                                 L"USB_CDC0_1"
...
//         <0xFE=>0xFE: Application Specific
//         <0xFF=>0xFF: Vendor Specific
#define USBD_CUSTOM_CLASS0_IF2_CLASS                               0x0A
...
//           <0=>OUT
//           <1=>IN
#define USBD_CUSTOM_CLASS0_IF2_EP0_BENDPOINTADDRESS                0x04
...
//           <0=>OUT
//           <1=>IN
#define USBD_CUSTOM_CLASS0_IF2_EP1_BENDPOINTADDRESS                0x84
...
#define USBD_CUSTOM_CLASS0_IF2_STR_EN                              1

//         <s.126>Interface String
#define USBD_CUSTOM_CLASS0_IF2_STR                                 L"USB_CDC0_1"
