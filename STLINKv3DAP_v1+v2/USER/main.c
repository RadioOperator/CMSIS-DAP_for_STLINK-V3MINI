/**
  ******************************************************************************
  * @file    main.c
  * @author  ARM CMSIS-DAP scource code, modified by RadioOperator
  *
...
__NO_RETURN void app_main (void *argument) {
  ...
  // Create CMSIS-DAP v1 HID Thread
  DAP_v1_ThreadId = osThreadNew(DAP_v1_Thread, NULL, &DAP_ThreadAttr);
  // Create CMSIS-DAP v2 WinUSB Thread
  DAP_v2_ThreadId = osThreadNew(DAP_v2_Thread, NULL, &DAP_ThreadAttr);

  // Create SWO Thread for CMSIS-DAP v2, cannot use SWO_STREAM mode in v1+v2
